...
int main() {
  ...
  transform_to_single_char_grammar(input_filename, output_filename,
                                   terminal_map, r_terminal_map,
                                   non_terminal_map, r_non_terminal_map);
